...
public enum MemberRtnCode {
	...
	MEMBER_NOT_PRESENT_OR_INFO_ERROR_OR_IS_ACTIVE("400", "尚未註冊會員或資料錯誤或已經生效會員"),
	MEMBER_NOT_PRESENT_OR_INFO_ERROR_OR_NOT_ACTIVE("400", "尚未註冊會員或資料錯誤或尚未生效會員"),
